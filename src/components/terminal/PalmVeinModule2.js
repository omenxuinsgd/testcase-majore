    ...
    <div className="flex-1 flex flex-col gap-4 p-4 overflow-hidden bg-black/40 font-mono text-left">
      {(activeTab === 'enrollment' || activeTab === 'identification') && (
        <div className="flex-1 flex flex-col gap-4 animate-in fade-in duration-500">
           ...
           <div className="grid grid-cols-4 gap-2 bg-zinc-900/80 p-3 border border-[#00ffff]/20 rounded-sm">
              <button 
                onClick={startPalmProtocol} 
                disabled={isScanning} 
                className={`flex items-center justify-center gap-2 py-2 text-[10px] font-black uppercase transition-all rounded-sm border-2 ${isScanning ? 'bg-zinc-800 border-zinc-700 text-zinc-500' : 'bg-[#00ffff]/10 border-[#00ffff] text-[#00ffff] hover:bg-[#00ffff] hover:text-black'}`}>
                <Play size={12} fill="currentColor" /> Start Sensor
              </button>
              
              <button 
                onClick={finishPalmProtocol} 
                className="flex items-center justify-center gap-2 py-2 text-[10px] font-black uppercase rounded-sm border-2 bg-red-500/10 border-red-500 text-red-500 hover:bg-red-500 hover:text-white">
              ...
              {activeTab === 'enrollment' ? (
                <button 
                  ...
                  className="col-span-2 flex items-center justify-center gap-2 py-2 text-[10px] font-black uppercase rounded-sm border-2 bg-emerald-500/20 border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-white disabled:opacity-30">
                ...
                <button 
                  ...
                  disabled={!isScanning || isProcessing}
                  className="col-span-2 flex items-center justify-center gap-2 py-2 text-[10px] font-black uppercase rounded-sm border-2 bg-purple-500/20 border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white disabled:opacity-30">
