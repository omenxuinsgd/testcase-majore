          ...
          <div className="flex flex-row items-end gap-6 text-left font-mono w-full mb-auto">
            ...
            <div className="flex-1 space-y-1">
              ...
              <div className="flex gap-1 h-9 items-center">
                ...
                <button onClick={handleDeinitSDK} disabled={!connStatus.cmd} className="px-4 h-full bg-white text-black text-[10px] font-black uppercase hover:bg-zinc-200 transition-all active:scale-95">DEINIT</button>
